...
function NewTicketPriority() {
    ...
    const CardTitleEdit = t("TicketPriorityCardTitleNewTicketPriority");
    const CardSubTitle = t("TicketPriorityCardSubTitleNewTicketPriority");
    const ErrorRequired = t('ErrorIsRequired');
    const ErrorMaxCaracter = t('ErrorMaxCaracter');
    const ErrorMinCaracter = t('ErrorMinCaracter');
    const CardButtonSave = t('TicketPriorityCardFormButtonSave');
