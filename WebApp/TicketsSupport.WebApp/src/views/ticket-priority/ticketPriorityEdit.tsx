...
function EditTicketPriority() {
    ...
    const CardTitleEdit = t("TicketPriorityCardTitleEditTicketPriority");
    const CardSubTitle = t("TicketPriorityCardSubTitleEditTicketPriority");
    const ErrorRequired = t('ErrorIsRequired');
    const ErrorMaxCaracter = t('ErrorMaxCaracter');
    const ErrorMinCaracter = t('ErrorMinCaracter');
    const CardButtonSave = t('TicketPriorityCardFormButtonEdit');
    const CardButtonCancel = t('TicketPriorityCardFormButtonCancel');
    const CardFormName = t('TicketPriorityCardFormName');
    const CardFormColor = t('TicketPriorityCardFormColor');
    ...
    useEffect(() => {
        if (httpCodePut === 200) {
            ...
            reset();
            setTimeout(() => navigate(paths.ticketPriorities), 3000);
        }
                ...
                <form className='mt-5 grid gap-2"' onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className='col-12'>
                        <div className='flex justify-content-center align-items-center'>
                            ...
                            <Link to={paths.ticketPriorities}>
