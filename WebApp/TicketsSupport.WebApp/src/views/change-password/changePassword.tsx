                        ...
                        {SendRequest === false ?
                            <>
                                <div className="col-10 sm:col-10 lg:col-4 bg-red h-25rem login-container">
                                    ...
                                    <h6 className="text-white text-4xl font-normal p-0 m-2 my-1 text-center">{Title}</h6>
                            ...
                            :
                            <>
                                <div className="col-10 sm:col-10 lg:col-4 bg-red h-16rem login-container">
                                    ...
                                    {/* Header Restore password */}
                                    <h6 className="text-white text-2xl font-normal p-0 m-2 my-2">{TitleSend}</h6>
                                    <h6 className="text-gray-300 text-sm font-light p-0 mt-2 mb-4 mx-2">{SubTitleSend}</h6>
                                    <Link to={returnPage}>
