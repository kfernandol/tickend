                  ...
                  {Menus.filter(x => x.parentId === null && x.show === true).sort((a, b) => a.position - b.position).map((menu, index) => {
                    return (
                      <div key={menu.name + index}>
                        ...
                        >
                          <div ref={(element) => menuRef[index] = element} className="p-ripple p-3 flex align-items-center justify-content-between text-600 cursor-pointer">
