            ...
            <div className="grid h-screen w-screen m-0 p-0">
                <div className="col-12 sm:col-6 sm:col-offset-3 md:col-5 md:col-offset-4 lg:col-10 lg:col-offset-1 lg:px-5 xl:col-8 xl:col-offset-2 xl:px-8">
                    ...
                    <div className="grid h-full justify-content-center align-items-center">
                        {SendHash === false ?
                            <>
                                <div className="col-10 sm:col-10 lg:col-4 bg-red h-25rem login-container">
                                    <Link to={returnPage} className='absolute'>
                                        <i className='pi pi-chevron-left' style={{ color: '#fff' }}></i>
                                    </Link>
                                    <div className='flex justify-content-center align-items-center w-full my-4'>
                                    ...
                                    <h6 className="text-white text-3xl font-normal p-0 m-2 my-3">{Title}</h6>
                                    <h6 className="text-gray-300 text-sm font-light p-0 my-2 mx-2">{SubTitle}</h6>
                            ...
                            <>
                                <div className="col-10 sm:col-10 lg:col-4 bg-red h-23rem login-container">
                                    ...
                                    {/* Header Restore password */}
                                    <h6 className="text-white text-3xl font-normal p-0 m-2 my-3">{TitleSend}</h6>
                                    <h6 className="text-gray-300 text-sm font-light p-0 my-2 mx-2">{SubTitleSend}</h6>
                                    <h4 className='text-center my-6'>{Email}</h4>
                                    <Link to={returnPage}>
