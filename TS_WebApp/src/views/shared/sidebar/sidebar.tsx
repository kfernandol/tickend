...
function Sidebar() {
  ...
  return (
    <div style={{ width: "auto", position: "relative" }}>
      <div id="app-sidebar-container" className="min-h-screen flex relative" >
        <div
          id="app-sidebar-2"
          className="h-screen hidden flex-shrink-0 absolute left-0 top-0 z-1 surface-border select-none"
          style={{ width: "280px" }}
        >
