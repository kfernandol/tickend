...
public partial class TS_DatabaseContext : DbContext
{
    ...
    public virtual DbSet<RolPermissionsLevel> RolPermissionsLevels { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Rol>(entity =>
        {
            ...
            entity.HasOne(d => d.PermissionLevel).WithMany(p => p.Rols).HasForeignKey(d => d.PermissionLevelId);
        });

        modelBuilder.Entity<RolPermissionsLevel>(entity =>
        {
            entity.ToTable("Rol_PermissionsLevel");
